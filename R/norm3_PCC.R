                       ...
                       main = "PCC Normal with unknown parameters")
{
  ...
  # if( !missing(a0) ) {
  #          if ( !is.numeric(a0) ) {
  #            stop("Invalid 'a0' value")
  #          } else {
  #            if ( a0<=0 ) {
  #              if ( a0!=-1/2 & b0!=0 & mu0!=0 & l0!=0 ) { stop("Invalid 'a0' value") }
  #            }
  #          }
  # }
...
#   if ( !is.numeric(a0) ) { stop("Invalid 'a0' value")
#   } else { if ( a0<=0 ) { if ( a0!=-1/2 & b0!=0 & mu0!=0 & l0!=0 ) { stop("Invalid 'a0' value") } } else { a0 <- a0[1] } }
# } else {
